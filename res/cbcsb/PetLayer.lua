...
Image_10:loadTexture("res/WeaponLayer/background.png",0)
...
--Create ArmatureNode_1_0
local ArmatureNode_1_0 = ccs.Armature:create()
ArmatureNode_1_0:setName("ArmatureNode_1_0")
ArmatureNode_1_0:setTag(91)
ArmatureNode_1_0:setCascadeColorEnabled(true)
ArmatureNode_1_0:setCascadeOpacityEnabled(true)
layout = ccui.LayoutComponent:bindLayoutComponent(ArmatureNode_1_0)
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("animation/cw3zs_Animation/cw3zs_Animation.ExportJson")
ArmatureNode_1_0:init("cw3zs_Animation")
ArmatureNode_1_0:getAnimation():play("Animation1",-1, 1)
i_cwbj2:addChild(ArmatureNode_1_0)
...
--Create ArmatureNode_1_1
local ArmatureNode_1_1 = ccs.Armature:create()
ArmatureNode_1_1:setName("ArmatureNode_1_1")
ArmatureNode_1_1:setTag(92)
ArmatureNode_1_1:setCascadeColorEnabled(true)
ArmatureNode_1_1:setCascadeOpacityEnabled(true)
layout = ccui.LayoutComponent:bindLayoutComponent(ArmatureNode_1_1)
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("animation/cw2zs_Animation/cw2zs_Animation.ExportJson")
ArmatureNode_1_1:init("cw2zs_Animation")
ArmatureNode_1_1:getAnimation():play("Animation1",-1, 1)
i_cwbj1:addChild(ArmatureNode_1_1)
...
top_line:setPosition(366.8789, 1141.0190)
...
layout:setLeftMargin(6.8789)
layout:setRightMargin(-6.8789)
layout:setTopMargin(110.4806)
layout:setBottomMargin(1112.5190)
...
bf_mz:setPosition(360.0000, 1222.4000)
...
i_dh:loadTexture("res/pet/animationblank.png",0)
...
layout:setPercentWidth(1.0000)
layout:setPercentHeight(0.3031)
layout:setSize({width = 720.0000, height = 388.0000})
layout:setHorizontalEdge(3)
layout:setTopMargin(697.0000)
...
b_0:loadTextureNormal("res/pet/get.png",0)
b_0:setTitleFontSize(14)
b_0:setTitleColor({r = 65, g = 65, b = 70})
b_0:setScale9Enabled(true)
b_0:setCapInsets({x = 15, y = 11, width = 253, height = 68})
...
layout:setSize({width = 283.0320, height = 90.0000})
layout:setHorizontalEdge(3)
layout:setLeftMargin(218.4840)
layout:setRightMargin(218.4840)
layout:setTopMargin(1161.9190)
layout:setBottomMargin(28.0807)
Layer:addChild(b_0)
...
s_jb:setPosition(272.9973, 240.9999)
layout = ccui.LayoutComponent:bindLayoutComponent(s_jb)
layout:setPositionPercentX(0.3792)
layout:setPositionPercentY(0.1883)
layout:setPercentWidth(0.0681)
layout:setPercentHeight(0.0383)
layout:setSize({width = 49.0000, height = 49.0000})
layout:setLeftMargin(248.4973)
layout:setRightMargin(422.5027)
layout:setTopMargin(1014.5000)
layout:setBottomMargin(216.4999)
...
s_yb:setPosition(269.0676, 247.7933)
...
layout:setRightMargin(423.9994)
layout:setTopMargin(1019.5000)
layout:setBottomMargin(221.4995)
...
bf_jq:setPosition(328.7661, 240.4802)
...
layout:setLeftMargin(328.7661)
layout:setRightMargin(289.2339)
layout:setTopMargin(1023.5200)
layout:setBottomMargin(224.4802)
