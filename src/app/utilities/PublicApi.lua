...
function cc.exports.setMusicVolume(percent)
	ww.WWGameData:getInstance():setIntegerForKey(ConstData.SETTING_MUSIC_PERCENT,percent)
	ww.WWSoundManager:getInstance():setBackgroundMusicVolume(percent/100.0)
	wwlog("publicApi","setMusicVolume "..percent)
end

function cc.exports.setSoundVolume(percent)
	ww.WWGameData:getInstance():setIntegerForKey(ConstData.SETTING_SOUND_PERCENT,percent)
	ww.WWSoundManager:getInstance():setEffectsVolume(percent/100.0)
	wwlog("publicApi","setSoundVolume "..percent)
end
function cc.exports.getMusicVolume()
	local volume = ww.WWGameData:getInstance():getIntegerForKey(ConstData.SETTING_MUSIC_PERCENT,100)
	wwlog("publicApi","getMusicVolume "..volume)
	return volume
end
function cc.exports.getSoundVolume()
	local volume = ww.WWGameData:getInstance():getIntegerForKey(ConstData.SETTING_SOUND_PERCENT,100)
	wwlog("publicApi","getSoundVolume "..volume)
	return volume
end